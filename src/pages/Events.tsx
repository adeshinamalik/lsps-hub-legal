...
const Events = () => {
  ...
  const staticEvents = [
    ...
    },
    {
      ...
      date: "July 12, 2023",
      description:
        "The annual Moot Court Competition is back! Showcase your advocacy skills and compete with law students from various universities. Prizes to be won and opportunities for internships with partner law firms.",
      imageSrc:
        "https://images.unsplash.com/photo-1589994965851-a8f479c573a9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80",
    ...
    },
    {
      ...
      date: "August 5, 2023",
      description:
        "Enhance your legal writing skills with our specialized workshop conducted by leading academics and legal professionals. Learn how to craft compelling legal arguments, opinions, and academic papers.",
      imageSrc:
    ...
    },
    {
      ...
      description:
        "Connect with potential employers from leading law firms, corporations, NGOs, and government agencies. Bring your CV and be prepared for on-the-spot interviews and networking opportunities.",
    ...
    },
    {
      ...
      date: "October 7, 2023",
      description:
        "An exclusive opportunity to hear from the Chief Justice of Nigeria on 'The Role of Young Lawyers in Advancing Justice Reform in Nigeria'. Limited seats available.",
  ...
  // Fetch events from Firestore and merge with static data
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        // Query Firestore, ordering by createdAt descending (newest first)
        ...
        <div className="container mx-auto">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Join us for our upcoming events, workshops, and activities designed to enhance your legal education and
              career prospects.
            </p>
          </div>
              ...
              >
                <div className="h-48 overflow-hidden">
                  <img
                    ...
                    onError={(e) => {
                      console.error(`Failed to load image: ${event.imageSrc}`);
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-gray-600 mb-6">
                  Our events provide excellent opportunities for knowledge sharing, networking, and professional
                  development for law students at the University of Ilorin.
                </p>
                <Button
