              ...
              <div>
                ...
                <div className="flex space-x-4">
                  <a 
                    ...
                    className="bg-law-muted hover:bg-law-accent/10 text-law-DEFAULT hover:text-law-accent w-10 h-10 rounded-full flex items-center justify-center transition-colors"
                  >
                    <Facebook size={20} />
            ...
            <div>
              <Card className="border-none shadow-subtle p-8 animate-fade-up" style={{ animationDelay: '100ms' }}>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button 
                    type="submit" 
                    className="w-full bg-law-DEFAULT hover:bg-law-light text-white"
